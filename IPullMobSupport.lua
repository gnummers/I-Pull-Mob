...
Support:RegisterMedia("sounds", "stack", "fojji Bell")
Support:RegisterMedia("sounds", "stack now", "fojji Bell")
Support:RegisterMedia("sounds", "spread", "fojji |cFFFF0000Watch your feet|r")
Support:RegisterMedia("sounds", "spread out", "fojji |cFFFF0000Watch your feet|r")
Support:RegisterMedia("sounds", "move", "fojji Swoosh")
Support:RegisterMedia("sounds", "kite", "fojji Swoosh")
Support:RegisterMedia("sounds", "dispel", "fojji Info")
Support:RegisterMedia("sounds", "phase2", "fojji Phase2")
Support:RegisterMedia("sounds", "phase2 soon", "fojji |cFFFF0000Phase2|r")
...
Support:RegisterMedia("sounds", "berserk soon", "fojji |cFFFF0000Berserk Soon|r")
Support:RegisterMedia("sounds", "taunt", "fojji Taunt")
Support:RegisterMedia("sounds", "watchfeet", "fojji |cFFFF0000Watch your feet|r")
Support:RegisterMedia("sounds", "watch feet", "fojji |cFFFF0000Watch your feet|r")
Support:RegisterMedia("sounds", "stack soon", "fojji |cFFFF0000Watch your feet|r")
